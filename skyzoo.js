...
let bang = m.key.id
await Skyzo.sendMessage(m.chat, {text: `@${m.sender.split("@")[0]} Maaf Kamu Akan Saya Keluarkan Dari Grup Ini Karna Admin/Owner Bot Menyalakan Fitur *Antilink* Grup Lain!`, contextInfo: {mentionedJid: [m.sender], externalAdReply: {thumbnailUrl: "https://k.top4top.io/p_3312s70dh0.png", title: "｢ LINK GRUP DETECTED ｣", previewType: "PHOTO"}}}, {quoted: m})
...
let delet = m.key.participant
let bang = m.key.id
await Skyzo.sendMessage(m.chat, {text: `@${m.sender.split("@")[0]} Maaf Pesan Kamu Saya Hapus Karna Admin/Owner Bot Menyalakan Fitur *Antilink* Grup Lain!`, contextInfo: {mentionedJid: [m.sender], externalAdReply: {thumbnailUrl: "https://k.top4top.io/p_3312s70dh0.png", title: "｢ LINK GRUP DETECTED ｣", previewType: "PHOTO"}}}, {quoted: m})
await Skyzo.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: false, id: bang, participant: delet }})
}
}}

const qdoc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {documentMessage: {title: 'Whatsapp Bot Vintrzy Hosting l Anti Kenon✨',jpegThumbnail: ""}}}

const qloc = {key: {participant: '0@s.whatsapp.net', ...(m.chat ? {remoteJid: `status@broadcast`} : {})}, message: {locationMessage: {name: `Whatsapp Jpm BOT Vintrzy HOSTING ANTI KENON✨`,jpegThumbnail: ""}}}

const qloc2 = {key: {participant: '0@s.whatsapp.net', ...(m.chat ? {remoteJid: `status@broadcast`} : {})}, message: {locationMessage: {name: `BOT PUSH KONTAK VINTRZY`,jpegThumbnail: ""}}}
...
const qbug = {key: {remoteJid: 'status@broadcast', fromMe: false, participant: '0@s.whatsapp.net'}, message: {listResponseMessage: {title: `Vintrzy Storee 💥`
}}}
...
m.reply("Berhasil Mengganti Foto Profil Bot JASA EDIT KE Vintrzy AJA 083153419618✅")
} else return m.reply(example('dengan mengirim foto'))
}
break
...
ppuser = 'https://img100.pixhost.to/images/759/541281776_always-aldoz.jpg'
}
...
break
case "vps": {
let teks = `*List Harga VPS By Vintrzy 😜*
*(ISP Digital Ocean)*
...
break
case "domain": {
let teks = `*List Harga Domain By Vintrzy 😜*
...
break
case "panel": {
const teks = `*LIST BOTZ BY Vintrzy 😜*
...
* *Harga :* Rp10.000/permanent
* Create Panel Lewat Bot

Minat ? Hubungi Ownerbot 083153419618*
`
Skyzo.sendMessage(m.chat, {text: teks}, {quoted: qloc})
}
break
...
const teks = `*TRANSAKSI DONE BY Vintrzy STORE*
...
newsletterName: `Testimoni By Vintrzy`
}}}, {quoted: qloc})
total += 1
} catch {}
await sleep(global.delayjpm)
...
let messageText = "*🌐 LIST SERVER PANEL BOT Vintrzy 🔥*\n\n"
...
if (!isOwner) return m.reply(msg.owner)
let teks = `*｢ LIST ALL PAYMENT VINTRZY STORE ｣*
